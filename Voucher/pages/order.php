                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    ...
                                                    if (isset($_COOKIE["auth_cookie"])) {
                                                        echo '<label>
                                                                Имя
                                                                <input type="text" name="name" form="order-form">
                                                            </label><br>
                                                            <label>
                                                                Почта
                                                                <input type="text" name="email" form="order-form">
                                                            </label><br>
                                                            <label>
                                                                Телефон
                                                                <input type="tel" name="phone" form="order-form">
                                                            </label><br>';
                                                    }
                                                    ?>
...
<br><br><br><br>
                                                        ...
                                                        <?php
                                                            if (isset($_COOKIE["auth_cookie"])) {
                                                                echo '<button type="submit" name="next" form="order-form">Далее</button>
                                                                ';
                                                            }
                                                        ?>
